    ...
    async render() {
        ...
        ${category.map((cate,index) =>{
            return `
                ...
                <td class="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-no-wrap p-4">
                <a href="/#/category/${cate.id}/edit" class="btn btn-primary px-3 py-2 bg-blue-500 rounded text-white">Edit</a>
                <button href="/#/category/${cate.id}" class="btn btn-remove btn-primary btn-remove px-3 py-2 bg-red-500 rounded text-white" data-id="${cate.id}">Delete</button>
                </td>
            </tr>
            `
        }).join("")}
